    ...
    $input_register_date = date("Y-m-d");
    ...
    <div class="wrapper">
        ...
        <form method="POST" action="succ_create_staff.php" class="ht-600 w-50">
            ...
            <div class="form-group">
                <label for="staff_id" class="form-label">Staff ID (Please Remember):</label>
            ...
            <div class="form-group">
                <label for="password">Password (Please Remember):</label>
            ...
            <div class="form-group">
                ...
                <input type="date" name="register_date" id="register_date" class="form-control <?php echo !$register_date_err ?: 'is-invalid';?>" required value="<?php echo $input_register_date; ?>" readonly><br>
                <div id="validationServerFeedback" class="invalid-feedback">
