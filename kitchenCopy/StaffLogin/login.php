...
<head>
    ...
    <style>
         body {
            ...
            display: flex;
            background-image: url('../../adminCopy/customerSide/image/loginpage.jpg'); /* Set the background image path */
...
<body>
    ...
    <a class="nav-link" href="#"> <h2 class="text-center" style="font-family:Copperplate; color:white;">My Bubble Time Cafe Kitchen Panel</h2><span class="sr-only"></span></a>
    ...
    <form action="login_process.php" method="post" >
        <div class="form-group">
            <label for="account_id">Kitchen Account ID</label>
