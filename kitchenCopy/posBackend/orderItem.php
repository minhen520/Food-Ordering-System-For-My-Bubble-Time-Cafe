            ...
            <tr>
                ...
                <td>RM <?php echo number_format(($tax * $cart_total) + $cart_total, 2); ?></td>
                        ...
                        if ($has_payment_time) {
                            ...
                            echo '<br><a href="posCashPayment.php?bill_id=' . $bill_id . '" class="btn btn-success">Cash/ Online Payment</a>';
                            echo '&nbsp; <a href="posCardPayment.php?bill_id=' . $bill_id . '" class="btn btn-success">Credit Card Payment</a>';
                        } else {
