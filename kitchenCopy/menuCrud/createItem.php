...
<form method="POST" action="success_create.php" class="ht-600 w-50" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input  name="item_price" id="item_price" placeholder="12.34" required class="form-control <?php echo (!empty($itemprice_err)) ? 'is-invalid' : ''; ?>" ><br>
            <span class="invalid-feedback"></span>
        </div>
        ...
        <div class="form-group">
            ...
            <a href="../panel/menu-panel.php" class="btn btn-dark" value="Cancel" style="margin-left: 20px">Cancel</a>
        </div> 
