            ...
            ?>
                    ...
                    <div class="text-right">
                        ...
                        if($member_point >= 10000){
                            ...
                            $update_member_point = "UPDATE memberships SET points = points - 10000 WHERE member_id = '$member_id'"; 
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group d-flex align-items-end">
                    ...
                    <button style="margin-left: 20px; margin-right: 20px"type="submit" id="cardSubmit" class="btn btn-dark mt-2" >Pay</button>
        ...
        if (isset($_GET['payment_amount'])) {
            ...
            if ($payment_amount >= $GRANDTOTAL) {
                ...
                if ($link->query($updateQuery) === TRUE) {
                    ...
                    // Update the session variable for logged customer points
