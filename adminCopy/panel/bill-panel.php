            ...
            <div class="m-50">
                <div class="mt-5 mb-3">
                    ...
                    <form method="POST" action="#">
                        <div class="row">
                            <div class="col-md-6">
                                <input required type="text" id="search" name="search" class="form-control" placeholder="Cautions! Please Login to Access your order history">
                            </div>
                            <div class="col-md-3">
                ...
                if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true) {
                    ...
                    $sql = "SELECT * FROM Bills WHERE member_id = " . $_SESSION['logged_customer_id'] . " ORDER BY bill_id DESC;";

                } else {
                    // User is not logged in, display only records with member_id = 0
                    $sql = "SELECT * FROM Bills WHERE member_id = 0 ORDER BY bill_id DESC LIMIT 1;";
                }
