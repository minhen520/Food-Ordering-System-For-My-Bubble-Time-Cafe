                    ...
                    if ($password === $row["password"]) {
                        ...
                        if ($result_member) {
                            ...
                            if ($membership_row) {
                                ...
                                header("location: ../posBackend/posTable.php"); // Redirect to the home page
                                exit;
                            } else {
  ...
  max-width: 500px; /* Set a maximum width for the container */
        ...
        body {
            ...
            background-color:black;
             background-image: url('../customerSide/image/loginpage.jpg'); /* Set the background image path */
...
<body>
    ...
    <div class="login_wrapper">
        <a class="nav-link" href="../customerSide/home/home.php#hero"> <h2 class="text-center" style="font-family:Copperplate; color:white;">My Bubble Time Cafe Customer Login</h2><span class="sr-only"></span></a>
    ...
    <span class="text-danger"><?php echo $password_err; ?></span>
            ...
            <p style="margin-top:1em; color:white;">Don't have an account? <a href="../customerSide/signup/signup.php" style="">Proceed to Register</a></p>
        </div>
    </div>
    </div>
</body>
