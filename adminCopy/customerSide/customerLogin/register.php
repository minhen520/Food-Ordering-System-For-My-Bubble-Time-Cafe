...
<body>
    ...
    <div class="register_wrapper"> <!-- Updated class name -->
        <a class="nav-link" href="../home/home.php#hero"> <h2 class="text-center" style="font-family:Copperplate; color:white;">My Bubble Time Cafe</h2><span class="sr-only"></span></a><br>
