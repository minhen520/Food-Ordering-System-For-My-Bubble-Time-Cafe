...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["password"]))) {
        ...
        $password_err = "Password must contain at least one alphabet.";
    } else {
                   ...
                   // Verify the password
                    if ($password === $row["password"]) {
                        ...
                        $_SESSION["email"] = $email;
                            ...
                            // Set the logged customer ID and name
                            $_SESSION['logged_customer_id'] = $row["account_id"];
                            $_SESSION['logged_customer_name'] = $sql_member["member_name"];
                        ...
                        if ($result_member) {
                            ...
                            if ($membership_row) {
                                ...
                                $_SESSION['logged_customer_id'] = $membership_row["member_id"];
                                $_SESSION['logged_customer_name'] = $membership_row["member_name"];
                                $_SESSION['logged_customer_points'] = $membership_row["points"];
                                if (!empty($_SESSION['latest_b'])){
                                    header("Location: ../../posBackend/orderItem.php?bill_id=" . $_SESSION['latest_b'] . "&table_id=" . $_SESSION['latest_t']);
                                }else{
  ...
  max-width: 500px; /* Set a maximum width for the container */
        ...
        body {
            ...
            background-color:black;
             background-image: url('../image/loginpage.jpg'); /* Set the background image path */
...
<body>
    ...
    <div class="login_wrapper">
        <a class="nav-link" href="../home/home.php#hero"> <h2 class="text-center" style="font-family:Copperplate; color:white;">My Bubble Time Cafe</h2><span class="sr-only"></span></a>
